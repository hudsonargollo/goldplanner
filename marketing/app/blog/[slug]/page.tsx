...
async function getPost(slug: string) {
  try {
    ...
    const res = await env.HUB.fetch(`https://goldplanner.clubemkt.digital/hub/api/blog/posts/${slug}`);
        ...
        <article className="relative mx-auto max-w-2xl px-6">
          ...
          {post.cover_illustration && (
            <div className="relative mt-8 aspect-[4/3] w-full overflow-hidden rounded-2xl">
              <Image
                src={`https://goldplanner.clubemkt.digital/hub/api/blog/media/${post.cover_illustration}`}
                alt=""
                fill
                sizes="100vw"
