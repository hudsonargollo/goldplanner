...
// fetch("https://goldplanner.clubemkt.digital/hub/...") — a same-zone subrequest from
// this Worker to a different Worker on the same zone gets misrouted back
// into this Worker's own fetch handler rather than reaching goldplanner-hub.
async function getPosts() {
  try {
    const { env } = getRequestContext();
    const res = await env.HUB.fetch("https://goldplanner.clubemkt.digital/hub/api/blog/posts");
    if (!res.ok) return [];
    ...
    <>
      ...
      <main className="relative min-h-screen bg-ivory pt-32 pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          <div className="mb-14">
            <p className="label-tech mb-4">Gold Planner · Arquivo</p>
            ...
            <p className="mt-4 max-w-xl text-pretty text-lg leading-relaxed text-ink/60">
              Sistemas, produtos e as decisões por trás de como a Gold Planner constrói.
            </p>
          </div>
