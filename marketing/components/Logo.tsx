/**
 * The brand mark — a speech-bubble pierced by an upward growth arrow, from
 * the Gold Traffic brand kit (Ícone/Vector.svg). Always solid brand orange;
 * `variant` is accepted for backward compatibility with existing call sites
 * but no longer changes anything — the mark reads fine on both light and
 * dark surfaces at full saturation.
 */
...
export default function Logo({
  ...
  return (
    <svg viewBox="0 0 1613 1607" role="img" aria-label="Gold Traffic" className={className}>
      <path
