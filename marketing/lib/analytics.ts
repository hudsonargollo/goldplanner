// Funnel tracking: page_view -> cta_click -> form_start -> form_complete, posted to the
// Hub's D1-backed /hub/api/analytics endpoint (same origin as the marketing
// site — goldplanner.clubemkt.digital serves both — so this is a plain browser fetch, no
...
export type MarketingEventType = "page_view" | "cta_click" | "form_start" | "form_complete";
