...
const nextConfig = {
  // This app now lives inside the goldplanner-app monorepo (marketing/), which
  ...
  images: {
    ...
    remotePatterns: [{ protocol: "https", hostname: "goldplanner.clubemkt.digital", pathname: "/hub/api/blog/media/**" }],
  },
};
...
// Cloudflare — dedicated bucket `goldplanner-founder-video`, public access
...
export default withNextVideo(nextConfig, {
  ...
  providerConfig: {
    "cloudflare-r2": {
      ...
      bucket: "goldplanner-founder-video",
