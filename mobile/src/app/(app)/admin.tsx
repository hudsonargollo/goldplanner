...
// of ~/.claude/plans/goldplanner-mobile-parity.md. Same three tabs as web.
...
function OnboardingTab({ onError }: { onError: (e: string) => void }) {
  ...
  const [newOwner, setNewOwner] = useState<"goldplanner" | "customer">("goldplanner");
  const [busy, setBusy] = useState<string | null>(null);
  ...
  return (
    <View style={styles.stepBox}>
      ...
      <PickerModal
        ...
        selected={[step.owner]}
        onToggle={(v) => { onChange({ owner: v as "goldplanner" | "customer" }); setOwnerOpen(false); }}
