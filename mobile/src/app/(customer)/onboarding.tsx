...
// owner: "goldplanner" steps are read-only status chips. Phase 7 of
// ~/.claude/plans/goldplanner-mobile-parity.md.
                  ...
                  {steps.map((s) => (
                    <View key={s.id} style={styles.stepRow}>
                      ...
                      <View style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {s.owner !== "customer" ? <Text style={styles.stepOwner}>responsável: goldplanner</Text> : null}
                      </View>
                    </View>
                  ))}
                </View>
