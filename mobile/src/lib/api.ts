// REST client for the goldplanner-app kanban API — mirrors web's src/lib/api.js
...
export const API_BASE = process.env.EXPO_PUBLIC_API_BASE || "https://tasks.goldplanner.clubemkt.digital";
