...
// goldplanner.clubemkt.digital/crm/api/* — a different origin from the goldplanner-app Pages
...
export const CRM_API_BASE = process.env.EXPO_PUBLIC_CRM_API_BASE || "https://goldplanner.clubemkt.digital/crm";
