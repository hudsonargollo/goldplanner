...
import { LayoutGrid, Wallet, Briefcase, Newspaper, Sparkles, ShieldCheck, ListChecks, TrendingUp, ChevronsLeft, ChevronsRight, Award, Link2, LayoutTemplate, ScrollText } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { key: "devlogs", label: "Project Logs", icon: ScrollText, show: () => true },
