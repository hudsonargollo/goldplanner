    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-clay px-6">
      ...
      >
        <div className="mb-8 flex flex-col items-center text-center">
          <LogoMark className="mb-4 h-14 w-auto" />
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="voce@goldplanner.clubemkt.digital"
                    className={fieldCls}
                  />
                </div>
                <Err error={error} />
            ...
            {step === "forgot" && (
              ...
              >
                ...
                <a
                  href={`mailto:${ADMIN_CONTACT}?subject=Reset%20de%20acesso%20-%20GOLDPLANNER%20Operações&body=Olá,%20preciso%20redefinir%20minha%20senha%20de%20acesso%20ao%20painel.`}
        ...
        <p className="mt-5 text-center font-mono text-[11px] text-stone-300">
          ...
          goldplanner.clubemkt.digital{import.meta.env.BASE_URL}
        </p>
      </motion.div>
    </div>
  );
