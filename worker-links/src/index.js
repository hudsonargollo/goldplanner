/**
 * go.goldplanner.clubemkt.digital/<slug> -> wa.me/<phone>?text=<message>, or an arbitrary
 * destination URL, depending on the link's type. Reads the SAME hub-goldplanner
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (!slug) return Response.redirect("https://goldplanner.clubemkt.digital", 302);
