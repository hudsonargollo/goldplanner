...
// ~/.claude/plans/goldplanner-adaptive-onboarding.md). Each key is a
...
export const ONBOARDING_RULES = {
  site_institucional: [
    { title: "Reunião de kickoff", description: "Alinhar objetivos, público-alvo e referências visuais com o cliente.", owner: "goldplanner", category: "kickoff", dueOffsetDays: 2 },
    ...
    { title: "Definir estrutura de páginas", description: "Mapear as páginas do site e a hierarquia de navegação.", owner: "goldplanner", category: "technical", dueOffsetDays: 4 },
    { title: "Desenvolvimento do site", description: "Construção das páginas conforme o brief e conteúdo recebido.", owner: "goldplanner", category: "technical", dueOffsetDays: 14 },
    ...
    { title: "Publicação", description: "Deploy em produção e apontamento final de domínio.", owner: "goldplanner", category: "launch", dueOffsetDays: 21 },
  ],
  loja_virtual: [
    { title: "Reunião de kickoff", description: "Alinhar catálogo, formas de pagamento e frete com o cliente.", owner: "goldplanner", category: "kickoff", dueOffsetDays: 2 },
    ...
    { title: "Configuração da loja", description: "Setup da plataforma, catálogo, pagamento e frete.", owner: "goldplanner", category: "technical", dueOffsetDays: 18 },
    { title: "Teste de compra ponta a ponta", description: "Simular uma compra completa antes de publicar.", owner: "goldplanner", category: "launch", dueOffsetDays: 22 },
    { title: "Publicação", description: "Deploy em produção e apontamento final de domínio.", owner: "goldplanner", category: "launch", dueOffsetDays: 25 },
  ],
  sistema_interno: [
    { title: "Reunião de kickoff técnico", description: "Levantar processos atuais, usuários e integrações necessárias.", owner: "goldplanner", category: "kickoff", dueOffsetDays: 3 },
    ...
    { title: "Desenvolvimento", description: "Construção do sistema conforme o fluxo validado.", owner: "goldplanner", category: "technical", dueOffsetDays: 30 },
    { title: "Treinamento da equipe", description: "Sessão de treinamento com os usuários finais do sistema.", owner: "goldplanner", category: "training", dueOffsetDays: 33 },
    { title: "Publicação", description: "Deploy em produção.", owner: "goldplanner", category: "launch", dueOffsetDays: 35 },
  ],
  app_mobile: [
    { title: "Reunião de kickoff", description: "Alinhar plataformas alvo (iOS/Android), funcionalidades e referências.", owner: "goldplanner", category: "kickoff", dueOffsetDays: 3 },
    ...
    { title: "Desenvolvimento", description: "Construção do app conforme o escopo definido.", owner: "goldplanner", category: "technical", dueOffsetDays: 35 },
    ...
    { title: "Publicação nas lojas", description: "Submissão para a Apple App Store e/ou Google Play.", owner: "goldplanner", category: "launch", dueOffsetDays: 42 },
  ],
  automacao: [
    { title: "Reunião de kickoff", description: "Mapear o processo manual atual e o resultado esperado da automação.", owner: "goldplanner", category: "kickoff", dueOffsetDays: 2 },
    ...
    { title: "Implementação", description: "Construção e configuração da automação.", owner: "goldplanner", category: "technical", dueOffsetDays: 12 },
    { title: "Teste em paralelo", description: "Rodar a automação em paralelo ao processo manual antes de substituir.", owner: "goldplanner", category: "launch", dueOffsetDays: 15 },
    { title: "Ativação", description: "Desligar o processo manual e ativar a automação em definitivo.", owner: "goldplanner", category: "launch", dueOffsetDays: 17 },
  ],
};
